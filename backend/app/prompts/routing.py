...
def understanding_workflow_prompt() -> str:
    return (
        ...
        "Use clarify only when the assistant genuinely needs one more detail before choosing a path; do not clarify "
        "when the user asks a broad but answerable knowledge-base question. "
