...
def understanding_workflow_prompt() -> str:
    return (
        ...
        "Use knowledge_policy for store policy, company/contact/support, shipping, returns, refund, payment, "
        "ordering, samples, showroom, sales contact, or other knowledge-base questions. "
        ...
        "that does not need retrieval. "
        "Use off_topic for unrelated requests outside shopping/support or unsafe boundary-violating requests. "
        "Use clarify only when the assistant genuinely needs one more detail before choosing a path. "
