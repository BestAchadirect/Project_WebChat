...
from app.services.chat.parsing.parser_rule_types import ParserRuleSet, build_rule_set, empty_rule_set
from app.services.chat.text_normalization import normalize_db_value as _normalize_text
...
async def refresh_parser_rule_cache(db: AsyncSession) -> ParserRuleSet:
    ...
    async with _cache_lock:
        if not hasattr(db, "execute"):
            logger.debug("parser_rule_cache.refresh received db without execute(); returning empty rules")
            _parser_rules = empty_rule_set()
