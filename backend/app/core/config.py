...
class Settings(BaseSettings):
    ...
    CHAT_INTENT_CLASSIFICATION_MAX_TOKENS: int = 500
    ...
    CHAT_ATTRIBUTE_INTERPRETATION_TIMEOUT_SECONDS: float = 30.0
    CHAT_ATTRIBUTE_INTERPRETATION_REASONING_EFFORT: str = "low"
    CHAT_DETAIL_QUERY_MAX_TOKENS: int = 800
    CHAT_ATTRIBUTE_INTERPRETATION_MIN_CONFIDENCE: float = 0.55
    CHAT_QUERY_UNDERSTANDING_V2_ENABLED: bool = False
    CHAT_QUERY_UNDERSTANDING_MODEL: str = ""
    CHAT_QUERY_UNDERSTANDING_MAX_TOKENS: int = 1000
    CHAT_QUERY_UNDERSTANDING_TIMEOUT_SECONDS: float = 30.0
    CHAT_QUERY_UNDERSTANDING_MIN_CONFIDENCE: float = 0.55
    CHAT_QUERY_UNDERSTANDING_REASONING_EFFORT: str = "low"
    CHAT_CLARIFICATION_LOOP_MAX: int = 2
    ...
    CHAT_KNOWLEDGE_ANSWER_JSON_MAX_TOKENS: int = 700
