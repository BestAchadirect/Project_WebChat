...
def _build_understanding_result(*, case: dict[str, object]) -> UnderstandingResult:
    ...
    return UnderstandingResult(
        ...
        intent=str(understanding.get("intent") or "clarify"),
        subintent=str(understanding.get("subintent") or ""),
        user_goal=str(understanding.get("user_goal") or ""),
        product_query=str(understanding.get("product_query") or ""),
        response_policy=str(understanding.get("response_policy") or "ask_clarifying_question"),
        clarify_question=str(understanding.get("clarify_question") or ""),
        pending_task_type=str(understanding.get("pending_task_type") or ""),
        missing_slot=str(understanding.get("missing_slot") or ""),
