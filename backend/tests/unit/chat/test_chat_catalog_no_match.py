...
def test_structured_no_match_reply_summarizes_all_filters() -> None:
    ...
    assert "Category Sterilized and Opal Body Jewelry" in reply
    assert "Color Clear Opal" in reply
    assert "couldn't find products matching all of these details" in reply
